...
import dev.lumareth.moreMissiles.block.types.AluminumWingHardpointBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ALUMINUM_WING_HARDPOINT = BLOCKS.register("aluminum_missile_hardpoint", () -> new AluminumWingHardpointBlock(Block.Properties.of().strength(1.0f).noOcclusion()));
}
